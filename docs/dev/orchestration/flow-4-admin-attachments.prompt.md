...
You are implementing **Flow 4 (Admin Attachments)** of the _Portal de Clientes_ feature in the `corp-tickets` repo. This flow is **fully independent** — it can run start-to-finish without Flow 2 or Flow 3. You run cold — everything you need is here plus the two reference docs.
