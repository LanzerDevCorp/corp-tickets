...
You are implementing **Flow 2 (Client Auth)** of the *Portal de Clientes* feature in the `corp-tickets` repo. You run cold — everything you need is here plus the two reference docs.
