...
You are implementing **Flow 3 (Client Portal)** of the _Portal de Clientes_ feature in the `corp-tickets` repo. You run cold — everything you need is here plus the two reference docs.
